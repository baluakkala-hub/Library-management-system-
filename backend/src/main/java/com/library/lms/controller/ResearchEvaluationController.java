...
@Tag(name = "System Performance & Metrics API", description = "Collects and exports system performance and search evaluation metrics")
public class ResearchEvaluationController {

    private final ResearchEvaluationService researchService;

    @GetMapping("/benchmark")
    @Operation(summary = "Get aggregated system evaluation metrics (Latency, Precision@K, MAE, RMSE)")
    ...
    @Operation(summary = "Export system benchmark dataset and query logs as CSV file")
